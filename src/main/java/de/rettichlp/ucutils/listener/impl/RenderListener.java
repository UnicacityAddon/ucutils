...
public class RenderListener implements IHudRenderListener {
    ...
    @Override
    public void onHudRender(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        renderNotifications(graphics);
        renderWidgets(graphics);
    }

    private void renderNotifications(GuiGraphicsExtractor graphics) {
    ...
    private void renderWidgets(GuiGraphicsExtractor graphics) {
