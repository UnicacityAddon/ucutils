...
public class CarListener implements IMessageReceiveListener {
    ...
    private static final Pattern CAR_UNLOCK_PATTERN = compile("^\\[Car] Du hast deinen .+ aufgeschlossen\\.$|^\\[Car] Dein .+ wurde automatisch aufgeschlossen\\.$");
    private static final Pattern CAR_LOCK_PATTERN = compile("^\\[Car] Du hast deinen .+ abgeschlossen\\.$|^\\[Car] Motor automatisch gestartet · Türen verriegelt\\.$");
